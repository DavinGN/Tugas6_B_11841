...
model = load_model(r'D:\Sem 5\Pembelajaran Mesin\Tugas6_B_11841\model_mobilenet.h5')
...
def custom_progress_bar(confidence, color1, color2):
    ...
    progress_html = f"""
    <div style="border: 1px solid #dd; border-radius: 5px; overflow: hidden; width: 100%; font-size: 14px;">
...
st.title("Prediksi Kematangan Buah Naga - 1841")
